...
Beginning in January 1997, all respondents who usually worked less 
...
This table shows the proportion of men and women working part-time because of 
"Caring for children" in a given year.Some trends can be observed from the data:
...
This graph indicates the ratio of part-time job men whose doing part time reason is mostly because of children caring. The x-axis represents years which from 2006 to 2019, while the y-axis represents the ratio of part-time job men in each year.

The points indicate the specific ratio in each year and the line shows the trend of the ratio of part-time job men throughout the year. In the graph, we can find that the most ratio points are around the line, besides some edge values, like 2015's, and the line has a positive slope, which means the ratio of men who do the part-time due to caring for their children is almost increasing over year.
...
The output is 0, indicating that none of the bootstrap samples had a mean less than the observed mean. Therefore, the p-value is 0, suggesting strong evidence against the null hypothesis. This implies that the average percentage of men who choose to work part-time because of childcare is significantly less than 0.5, supporting the alternative hypothesis that μm < 0.5.
